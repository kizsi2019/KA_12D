...
var koltsegvetesvezerlo = (function(){
    ...
    return{
        ...
        tetelTorol: function(tip,id)
        {
            ...
            {
                console.error('a tetel nem letezik');
            }
        },
...
{
    var veztetelID , splitID, tipus,ID
    ...
    //1. tetel törlésse az adat obj-bol
    koltsegvetesvezerlo.tetelTorol(tip, ID);

    // 2 tetel torlese a feluletröl
    feluletvezerlo.tetelTorles(tetelID);
    // 3. osszegek ujraszamolasaes megjelenitese a feluleten
    osszegFrissitese();
