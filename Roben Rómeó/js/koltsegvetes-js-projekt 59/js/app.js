...
var koltsegvetesvezerlo = (function(){
    ...
    return{
        ...
        {
            var kiadasSzazalek = adat.tetelek.kia.map(function(currentValue)
            {
                return currentValue.getSzazalek();
            }
            );
            return kiadasSzazalek;
        },
...
{
    // 1. szazalek ujraszamolas 
    
    koltsegvetesvezerlo.szazalekSzamolasa();


    // 2. szazalek kiolvasása a vezérlőből
    var kiadasSzazalek = koltsegvetesVezerlo.szazalekokLekerdezese();
    // 3. felulet frissitése
    console.log(kiadasSzazalek);
