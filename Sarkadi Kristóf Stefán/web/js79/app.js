...
var kuzin = new AdamsFamily('Kuzin', 1808, 'Hogyishívják');
...
kerdes.set('kerdes', 'Hogyan hívják a de miééért reklámban szereplő kisfiút?'),
kerdes.set(1, 'Ödön');
kerdes.set(2, 'Ábel');
kerdes.set(3, 'Mikláska');
kerdes.set(4, 'Nándi');
