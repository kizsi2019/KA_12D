...
namespace CRUD
{
    public partial class Form1 : Form
    {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string creatTable = "create table test_table(id int, name varchar(50), fname varchar(50))";
            MySqlCommand cmd = new MySqlCommand(creatTable, con);
        ...
        private void btnUpdtae_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection con = new MySqlConnection(conString);
            con.Open();
            string updateTable = "Update test_table set name='Gyula' where fname='Takacs'";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection con = new MySqlConnection(conString);
            con.Open();
            string delete = "Delete from test_table where id = 3s";
